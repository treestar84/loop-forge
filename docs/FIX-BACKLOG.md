...
| E2-B | 장기·아발론·카탄 — 채택 후보 0개 상태부터 해결(GAP-11 적용 전 선행 과제). 게임별 A8 도메인 재설계 카드는 GAP-12 §7 표 참고 | 진행 중(장기 **완료** — janggiPieceSafetyMobility adopted v1→v2, holdout 95.0%[85.0-100%]. 아발론 **1차 실패**(2026-08-05) — avalonSuspicionTracking(투표이력 베이지안 의심도, 관찰에 이력 존재 확인 후 순수함수로 구현) smoke 20.0%로 SPRT 기각. 원인 가설 3개 기록(참가 페널티가 무고한 서번트를 오염시킴·미션 5회뿐이라 신호 축적 부족·멀린/이블은 이미 정보가 있어 무의미). **2차도 실패**(원인 분리 3후보 — avalonSuspicionVoteOnly smoke 25.3%, avalonSuspicionProposalOnly screen no-op, avalonSuspicionGoodOnly smoke 24.7%, 전부 failed) — 가설 ①·③ 둘 다 기각(제거해도 회복 안 됨), 상세는 docs/GAP-11-ROUNDS.md "아발론 A8 2차 시도(원인 분리)" 참고. 의심도 축적 메커니즘 축 소진 — 다음은 완전히 다른 축 필요. 카탄 남음) |
