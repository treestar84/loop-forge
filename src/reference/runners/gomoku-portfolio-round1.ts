...
import { buildCandidates, type RoundCandidate } from './shared/gomoku-round1-candidates';
...
// ---------------------------------------------------------------------
// Step 2: candidate batch (B1/B2/B3/B4 — see file doc comment). Moved to
// ./shared/gomoku-round1-candidates.ts (GAP-11 Phase 4-A) so a later round's
// runner can import `buildCandidates` without triggering this file's own
// unconditional `main()` (see that module's own doc comment) — behavior is
// unchanged, only the definition's location moved.
// ---------------------------------------------------------------------
