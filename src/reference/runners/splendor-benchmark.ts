/**
 * splendor-benchmark — the 3-column win-rate benchmark of
 * docs/BENCHMARK-EXPERIMENT.md, run for splendor. This is NOT an onboarding
 * runner (that is reference/runners/splendor.ts, which scores conformance and
...
const BOT_SEED_BASE = { A: 810_001, B: 820_002, C: 830_003 } as const;
...
function main(): void {
  ...
  console.log(`=== splendor 3-column benchmark (N=${n} seeds/column) ===`);
